...
* KMID : KM56BESD04
* Date : 29-09-2024
* Program: Read n numbers from the user and print the biggest number of all. 
* Sample Input :5
...
int main()
{
	int i=1,n,n1,n2,s,ret;//declaring inputs
	...
	s=n1;//moving the 1st number to variable a for comparing later in loop
	...
	while(i<=n)//loop untill all numbers are read
	{
		...
		if(ret!=1)
			printf("Enter number only\n");
		if(s<n2)//comparing number with previous and if true the biggest number is stored in s and a
		{
